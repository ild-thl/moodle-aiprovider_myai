...
class process_generate_text extends abstract_processor {
    ...
    protected function get_endpoint(): UriInterface {
        return new Uri(get_config('aiprovider_myai', 'action_generate_text_endpoint'));
    }

    #[\Override]
    protected function get_model(): string {
        return get_config('aiprovider_myai', 'action_generate_text_model');
    }

    #[\Override]
    protected function get_system_instruction(): string {
        return get_config('aiprovider_myai', 'action_generate_text_systeminstruction');
    }
