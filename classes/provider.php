...
class provider extends \core_ai\provider {
    ...
    public function __construct() {
        ...
        $this->apikey = get_config('aiprovider_myai', 'apikey');
        // Get api org id from config.
        $this->orgid = get_config('aiprovider_myai', 'orgid');
        // Get global rate limit from config.
        $this->enableglobalratelimit = get_config('aiprovider_myai', 'enableglobalratelimit');
        $this->globalratelimit = get_config('aiprovider_myai', 'globalratelimit');
        // Get user rate limit from config.
        $this->enableuserratelimit = get_config('aiprovider_myai', 'enableuserratelimit');
        $this->userratelimit = get_config('aiprovider_myai', 'userratelimit');
    }
