...
$string['action:generate_video:model'] = 'KI-Modell';
$string['action:generate_video:model_desc'] = 'Das Modell, das verwendet wird, um das Video zu generieren.';
$string['action:generate_video:endpoint'] = 'API endpoint';
$string['action:generate_video:systeminstruction'] = 'Systemanweisung';
$string['action:generate_video:systeminstruction_desc'] = 'Diese Anweisung wird zusammen mit der Eingabe des Benutzers an das KI-Modell gesendet. Es wird nicht empfohlen, diese Anweisung zu bearbeiten, es sei denn, es ist absolut erforderlich.';
...
$string['generate_video_description'] = 'Generiert ein kurzes Video basierend auf ausgewählten Kursinhalten und einer Textbeschreibung.';
$string['generate_video_systeminstruction'] = 'Erstelle ein kurzes Video basierend auf dem bereitgestellten Text. Das Video sollte relevante visuelle Elemente enthalten, die den Textinhalt ergänzen und veranschaulichen. Achte darauf, dass das Video ansprechend und informativ ist.'; 
