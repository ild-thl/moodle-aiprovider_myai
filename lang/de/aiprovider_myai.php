...
$string['action:text_to_speech:model'] = 'KI-Modell';
$string['action:text_to_speech:model_desc'] = 'Das Modell, das verwendet wird, um Audio aus Text zu erzeugen.';
$string['action:text_to_speech:endpoint'] = 'API endpoint';
$string['action:text_to_speech:voice'] = 'Stimme';
$string['action:text_to_speech:voice_desc'] = 'Stimme fuer die Text-zu-Sprache-Ausgabe (z. B. alloy).';
$string['action:text_to_speech:format'] = 'Audioformat';
$string['action:text_to_speech:format_desc'] = 'Ausgabeformat fuer Audio (z. B. mp3, wav oder opus).';
$string['action:text_to_speech:speed'] = 'Sprechgeschwindigkeit';
$string['action:text_to_speech:speed_desc'] = 'Geschwindigkeitsfaktor fuer die generierte Sprachausgabe (z. B. 1.0).';
$string['action:text_to_speech:systeminstruction'] = 'Systemanweisung';
$string['action:text_to_speech:systeminstruction_desc'] = 'Diese Anweisung wird zusammen mit der Eingabe des Benutzers an das KI-Modell gesendet. Es wird nicht empfohlen, diese Anweisung zu bearbeiten, es sei denn, es ist absolut erforderlich.';
$string['action:generate_question:endpoint'] = 'API endpoint';
$string['action:generate_question:model'] = 'KI-Modell';
$string['action:generate_question:model_desc'] = 'Das Modell, das verwendet wird, um Fragensaetze aus Lerninhalten zu generieren.';
$string['action:generate_question:systeminstruction'] = 'Systemanweisung';
$string['action:generate_question:systeminstruction_desc'] = 'Diese Anweisung wird zusammen mit der Eingabe des Benutzers an das KI-Modell gesendet. Es wird nicht empfohlen, diese Anweisung zu bearbeiten, es sei denn, es ist absolut erforderlich.';
...
$string['text_to_speech_description'] = 'Verwandelt einen Text in Audio.';
$string['text_to_speech_systeminstruction'] = 'Wandle den bereitgestellten Text in eine klare und natürlich klingende Sprache um. Stelle sicher, dass das Audio ansprechend und leicht verständlich ist, mit angemessener Intonation und Sprechgeschwindigkeit.';
$string['generate_question_description'] = 'Erzeugt Moodle-kompatible Fragensaetze aus Quellinhalten.';
$string['generate_question_systeminstruction'] = 'Du erzeugst qualitativ hochwertige, Moodle-kompatible Fragen aus Quellinhalten. Befolge Formatvorgaben exakt und gib nur das angeforderte Ausgabeformat zurueck.';
