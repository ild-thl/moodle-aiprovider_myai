...
$string['action:text_to_speech:model'] = 'AI model';
$string['action:text_to_speech:model_desc'] = 'The model used to create audio from text.';
$string['action:text_to_speech:endpoint'] = 'API endpoint';
$string['action:text_to_speech:voice'] = 'Voice';
$string['action:text_to_speech:voice_desc'] = 'Voice used for text-to-speech output (for example: alloy).';
$string['action:text_to_speech:format'] = 'Audio format';
$string['action:text_to_speech:format_desc'] = 'Output audio format (for example: mp3, wav, or opus).';
$string['action:text_to_speech:speed'] = 'Speech speed';
$string['action:text_to_speech:speed_desc'] = 'Playback speed multiplier for generated speech (for example: 1.0).';
$string['action:text_to_speech:systeminstruction'] = 'System instruction';
$string['action:text_to_speech:systeminstruction_desc'] = 'This instruction is sent to the AI model along with the user\'s prompt. Editing this instruction is not recommended unless absolutely required.';
$string['action:generate_question:endpoint'] = 'API endpoint';
$string['action:generate_question:model'] = 'AI model';
$string['action:generate_question:model_desc'] = 'The model used to generate question sets from learning content.';
$string['action:generate_question:systeminstruction'] = 'System instruction';
$string['action:generate_question:systeminstruction_desc'] = 'This instruction is sent to the AI model along with the user\'s prompt. Editing this instruction is not recommended unless absolutely required.';
...
$string['text_to_speech_description'] = 'Transforms a text into audio.';
$string['text_to_speech_systeminstruction'] = 'Convert the provided text into clear and natural-sounding speech. Ensure that the audio is engaging and easy to understand, with appropriate intonation and pacing.';
$string['generate_question_description'] = 'Generates Moodle-compatible question sets from source content.';
$string['generate_question_systeminstruction'] = 'You generate high-quality Moodle-compatible questions from source content. Follow formatting instructions exactly and return only the requested output format.';
